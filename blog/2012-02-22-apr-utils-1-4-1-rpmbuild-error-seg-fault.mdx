---
slug: apr-utils-1-4-1-rpmbuild-error-seg-fault
title: apr-utils 1.4.1 rpmbuild error (seg fault)
---
<p>When trying to build an rpm for apr-utils on my CentOS 6.2 box I got a nasty error when the rpm was running test [&hellip;]</p>
