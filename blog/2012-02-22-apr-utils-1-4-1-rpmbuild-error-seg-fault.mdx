...
This relates to this bug: [https://issues.apache.org/bugzilla/show_bug.cgi?id=52705](https://issues.apache.org/bugzilla/show_bug.cgi?id=52705)  

Thanks to Peter Poeml for releasing a patch for this, which I've put into an updated [apr-util.spec](pathname:///downloads/apr-util.spec)  
