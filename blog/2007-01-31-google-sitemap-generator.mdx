...
---
<p>I was dissapointed when I saw the current Google sitemap generators available, so I wrote one. Features: &#8211; Generates Google sitemaps &#8211; Generates Yahoo! sitemaps &#8211; Generates plain text sitemap &#8211; Splits sitemaps up into smaller files (as per Google's instructions) &#8211; Creates sitemap index file &#8211; Pings Google/Yahoo! This is the first release, so [&hellip;]</p>
...
<a href="http://www.noodles.net.nz/downloads/sitemaps.zip">http://www.noodles.net.nz/downloads/sitemaps.zip</a>  
